 ...
 * ucenter_member表：id,username,password,email,mobile,reg_time,reg_ip,last_login_time,last_login_ip,update_time,status
 * member表：uid,nickname,sex,birthday,qq,score,login,reg_ip,reg_time,last_login_ip,last_login_time,status,signature,tox_money,pos_povince,pos_city,pos_district,pos_community
 * ---------------------------------------------------------
 * 等级：title
