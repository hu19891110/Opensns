...
<?php echo hook('pageHeader');?>
    <link type="text/css" rel="stylesheet" href="/opensns/Public/Group/css/group.css"/>
    <script type="text/javascript" src="/opensns/Public/Group/js/common.js"></script>
</head>
<body>
<!-- 头部 -->
...
<a class="pull-left" href="<?php echo U('group/index/group',array('id'=>$group['id']));?>">
    ...
    <?php }else{ ?>
    <img class="logo img-responsive" width="238px" height="238px" src="/opensns/Public/Group/images/icon.jpg" alt="<?php echo (parseweibocontent(op_t($group["title"]))); ?>">
    <?php } ?>
</a>
