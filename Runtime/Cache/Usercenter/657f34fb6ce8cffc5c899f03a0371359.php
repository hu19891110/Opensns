...
<?php echo hook('pageHeader');?>
    <link href="/opensns/Public/Usercenter/css/center.css" type="text/css" rel="stylesheet">
</head>
<body>
...
<!-- 主体 -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="expandinfo_list" class="row expandinfo-list">
                            <?php if($uid == is_login()): ?><script type="text/javascript" src="/opensns/Public/Usercenter/js/expandinfo-form.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/opensns/Public/static/jcrop/jquery.Jcrop.css"/>
    <script src="/opensns/Public/static/jcrop/jquery.Jcrop.js"></script>
    <script src="/opensns/Public/static/browser/jquery.browser.js"></script>
    <script>
        var temp;
