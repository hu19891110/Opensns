...
<link type="text/css" rel="stylesheet" href="/opensns/Public/Core/js/ext/magnific/magnific-popup.css"/>
    ...
    <link href="/opensns/Public/Usercenter/css/usercenter.css" rel="stylesheet" type="text/css"/>
...
<div id="main-container" class="container">
    ...
    <div class="col-md-12 usercenter">
        <div class="uc">
                <div class="uc_top_bg">
        <img class="img-responsive" src="/opensns/Public/Usercenter/images/fractional.png" style="display: none">
    </div>
    <div class="row uc_info">
        ...
        <?php if(is_login() && $user_info['uid'] != get_uid()): ?><div class="col-md-3 col-xs-12">
            ...
            <?php if(ACTION_NAME=='information'){ $tabClass['user_data'] = 'uc_current'; } elseif(ACTION_NAME=='fans'||ACTION_NAME=='following'){ $tabClass['user_fans'] = 'uc_current'; } elseif(ACTION_NAME=='rankverify'||ACTION_NAME=='rank'||ACTION_NAME=='rankverifyfailure'||ACTION_NAME=='rankverifywait'){ $tabClass['user_rank'] = 'uc_current'; } else{ $tabClass[$type] = 'uc_current'; } ?>
