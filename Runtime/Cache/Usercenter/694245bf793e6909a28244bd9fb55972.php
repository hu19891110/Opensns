...
<link href="/opensns/Public/Weibo/css/weibo.css" rel="stylesheet"/>
<script src="/opensns/Public/Weibo/js/weibo.js"></script>
                ...
                <div class="col-xs-12">
                    ...
                    <span class="pull-right" style="margin-right: 20px;">
                      ...
                      <span class="ss" style="display: none">
                          <img src="/opensns/Public/Core/images/mark-aw1.png"/>
                      </span>
    ...
    function bind_weibo_managment1() {
        ...
        $('.ss').mouseover(function () {
            if ($(this).parents('.weibo_content').find('.mark_box').css('display') == 'none') {
                $(this).find('img').attr('src', '/opensns/Public/Core/images/mark-aw2.png');

            } else
                $(this).find('img').attr('src', '/opensns/Public/Core/images/mark-aw3.png');
        });

        $('.ss').mouseleave(function () {
            if ($(this).parents('.weibo_content').find('.mark_box').css('display') == 'none') {
                $(this).find('img').attr('src', '/opensns/Public/Core/images/mark-aw1.png');

            } else

                $(this).find('img').attr('src', '/opensns/Public/Core/images/mark-aw4.png');
