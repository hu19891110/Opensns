<?php if (!defined('THINK_PATH')) exit();?><div class="subscribe_btn_div hidden-xs">
    ...
    $(function () {
        ...
        $('#dingyue_btn').click(function () {
            ...
            if (email_address == '' || !patterns.test(email_address)) {
                ...
                $.post("<?php echo addons_url('Mail://Mail/subscribe');?>", {email_address: email_address}, function (res) {
                    if (res.status) {
