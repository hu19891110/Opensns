...
<style>
    ...
    <script>
        ...
        <?php if(is_login()): ?><div>
                <div id="weibo_filter" style="margin-bottom: 10px">
                        <a id="all"  href="<?php echo U('Weibo/Index/index');?>">全站动态</a>
    ...
    <div class="weibo_right col-md-4">
        ...
        <!--登录后显示个人区域-->
        <?php if(is_login()): ?><div ><img class="cover" src="/opensns/Public/Weibo/images/bg.jpg" style="height: 70px;width: 100%"></div>
