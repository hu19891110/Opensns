...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/opensns/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/opensns/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/opensns/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/opensns/Public/Admin/css/style.css" media="all">
    <link rel="stylesheet" type="text/css" href="/opensns/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/opensns/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<div id="main-content">
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">父导航<span class="check-tips">（仅支持二级）</span></label>
            <div class="controls">
               <select name="pid" >
                   <option <?php if(empty($pid)): ?>selected<?php endif; ?>value="0">顶级菜单</option>
                   <?php if(is_array($pnav)): $i = 0; $__LIST__ = $pnav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><option <?php if(($p["id"]) == $pid): ?>selected<?php endif; ?> value="<?php echo ($p["id"]); ?>"><?php echo ($p["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
               </select>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">文字颜色<span class="check-tips">（右上角的标志点颜色，支持各类css表示方式）</span></label>
            <div class="controls">
                <input type="text" class="text input-small" name="color" value="<?php echo ($info["color"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">标志点颜色<span class="check-tips">（右上角的标志点颜色，支持各类css表示方式）</span></label>
            <div class="controls">
                <input type="text" class="text input-small" name="band_color" value="<?php echo ($info["band_color"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">标志点文字<span class="check-tips">（右上角的标志点文字，不要太长，没有自动隐藏）</span></label>
            <div class="controls">
                <input type="text" class="text input-small" name="band_text" value="<?php echo ($info["band_text"]); ?>">
            </div>
        </div>
		<div class="form-item">
...
<script type="text/javascript" src="/opensns/Public/Admin/js/common.js"></script>
<script type="text/javascript">
    +function () {
