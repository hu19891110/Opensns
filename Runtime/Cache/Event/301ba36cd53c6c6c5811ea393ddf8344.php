                ...
                <div class="col-md-12">
                    <div class="event_header_title">
                        ...
                        <div class="btn-group btn-group-sm pull-right" style="margin-bottom:5px;">
                            <a href="<?php echo U('Tagview',array('norh'=>'new','type_id'=>$type_id,'tag_id'=>$tag_id));?>"
                             class="btn btn-default <?php if($norh == 'new'): ?>active<?php endif; ?>">最新</a>
                             <a href="<?php echo U('Tagview',array('norh'=>'hot','type_id'=>$type_id,'tag_id'=>$tag_id));?>"
                 ...
                 <?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix event_list">
                        <div class="col-md-5" style="padding: 0">
                            ...
                            <div class="pull-left col-md-7">
                                <div class="mgl20 event_title"><a href="<?php echo U('Event/Index/detail',array('id'=>$vo['id'],'type_id'=>$vo.type_id));?>"
...
<div class="common_block_border event_right">
    ...
    <div class="event_type clearfix" style="padding: 0 5px;margin-bottom: 5px">
        <a style="float: left" href="<?php echo U('tagview',array('norh'=>$norh,'tag_id'=>$tag_id));?>"
        ...
        <?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><a style="float: left"
            ...
            href="<?php echo U('tagview',array('type_id'=>$top['id'],'norh'=>$norh,'tag_id'=>$tag_id));?>" data="<?php echo ($top["id"]); ?>"><?php echo ($top["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
...
<div class="common_block_border event_right">
    ...
    <div class="event_type clearfix" style="padding: 0 5px;margin-bottom: 5px">
    <a style="float: left" href="<?php echo U('tagview',array('norh'=>$norh,'type_id'=>$type_id));?>"
        <?php if(($tag_id) == "0"): ?>class="cur"<?php endif; ?>
        >全部</a>
        <?php if(is_array($rec_tag)): $i = 0; $__LIST__ = $rec_tag;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$biaoq): $mod = ($i % 2 );++$i;?><a style="float: left"
            <?php if(($tag_id) == $biaoq['id']): ?>class="cur"<?php endif; ?>
            href="<?php echo U('tagview',array('tag_id'=>$biaoq['id'],'norh'=>$norh,'type_id'=>$type_id));?>" data="<?php echo ($biaoq["id"]); ?>"><?php echo ($biaoq["tag"]); ?></a><!-- q --><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
