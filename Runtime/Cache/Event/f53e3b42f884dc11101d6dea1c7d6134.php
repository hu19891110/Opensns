            ...
            <div class="col-md-8">
                <form class="form-horizontal  ajax-form" role="form" action="<?php echo U('Event/Index/doSign');?>" method="post">
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-10">
                            <input id="name" name="name" type="" class="form-control form_check" check-type="Text"  value="" placeholder="请填写姓名"/>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-10">
                            <input id="phone" name="phone" type="" class="form-control form_check" check-type="Phone"  value="" placeholder="请填写联系方式"/>
                        </div>

                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary " href="<?php echo U('Event/Index/doSign');?>">提交</button>
                        </div>
                    </div>
                </form>
            </div>
