                ...
                <div class="col-md-8">
                    <form class="form-horizontal ajax-form" role="form" action="<?php echo U('Event/Index/doPost');?>"
                        ...
                        <div class="form-group  has-feedback">
                            ...
                            <div class="col-sm-4">
                                <input id="biaoqian" name="biaoqian" class="time form-control form_check" check-type="Text" value="" placeholder="报名截止" required/>
                            </div>

                        </div>
                        <div class="form-group  has-feedback">
                            <label for="deadline" class="col-sm-2 control-label">活动标签<br>（逗号隔开）</label>
                            <div class="col-sm-4">
                                <input id="deadline" name="deadline" class="time form-control form_check" check-type="Text" value="" placeholder="活动标签" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php echo W('UeditorMini/editor',array('myeditor_edit','explain','','550px','250px',$config));?>
                            </div>
                        </div>
                        <div class="form-group">
