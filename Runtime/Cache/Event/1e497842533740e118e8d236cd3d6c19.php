...
<link type="text/css" rel="stylesheet" href="/opensns/Public/Core/js/ext/magnific/magnific-popup.css"/>
    ...
    <link href="/opensns/Public/static/datetimepickerV3/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css">
...
<div id="main-container" class="container">
                ...
                <div class="col-md-4">
                    <div class="controls">
                        ...
                        <div class="upload-img-box" style="margin-top: 20px;width:350px">
                            <div class="upload-pre-item"><img src="<?php echo (get_cover($content["cover_id"],'path')); ?>"></div>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    <form class="form-horizontal  ajax-form" role="form" action="<?php echo U('Event/Index/doPost');?>"
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-6">
                                <input id="title" name="title" class="form-control form_check" check-type="Text" value="<?php echo ($content["title"]); ?>" placeholder="标题"/>
                            </div>
                            <input type="hidden" name="id" id="id" value="<?php echo ($content["id"]); ?>"/>
                            <input type="hidden" name="cover_id" id="cover_id_cover" value="<?php echo ($content["cover_id"]); ?>"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select id="type_id" name="type_id" class="form-control">
                                    <?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><option value="<?php echo ($top["id"]); ?>" <?php if(($content['type_id']) == $top['id']): ?>selected<?php endif; ?>>
                                        <?php echo ($top["title"]); ?>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-3">
                                <input id="sTime" name="sTime" class="time_d form-control form_check" check-type="Date" value="<?php echo date('Y-m-d',$content['sTime']);?>" placeholder="开始时间"/>
                            </div>

                            <div class="col-sm-3">
                                <input id="eTime" name="eTime" class="time_d form-control form_check" check-type="Date" value="<?php echo date('Y-m-d',$content['eTime']);?>" placeholder="结束时间"/>
                            </div>
                        </div>
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-6">
                                <input id="address" name="address" class="form-control form_check" check-type="Text" value="<?php echo ($content["address"]); ?>" placeholder="地址"/>
                            </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-3">
                                <input id="limitCount" name="limitCount" class="form-control form_check" check-type="Num" value="<?php echo ($content["limitCount"]); ?>" placeholder="人数"/>
                            </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-4">
                                <input id="deadline" name="deadline" class="time form-control form_check" check-type="Text" value="<?php echo date('Y-m-d H:i',$content['deadline']);?>" placeholder="报名截止"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php echo W('UeditorMini/editor',array('myeditor_edit','explain',$content['explain'],'550px','250px',$config));?>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript" src="/opensns/Public/Event/js/form_check.js"></script>
    <script type="text/javascript" src="/opensns/Public/static/datetimepickerV3/js/bootstrap-datetimepicker.js"></script>
    <script type="text/javascript" src="/opensns/Public/static/datetimepickerV3/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
    <script>
        $("#upload_picture_cover").uploadify({
            "height": 30,
            "swf": "/opensns/Public/static/uploadify/uploadify.swf",
        ...
        function uploadPicturecover(file, data) {
            ...
            if (data.status) {
                ...
                src = data.url || '/opensns' + data.path
                $('.upload-img-box').html(
