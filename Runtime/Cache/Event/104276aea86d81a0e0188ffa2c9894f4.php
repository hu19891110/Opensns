...
<div id="main-container" class="container">
    ...
    <div class="btn-group btn-group-sm">
        <a class="btn btn-default  <?php if($tip == all): ?>active<?php endif; ?>" href="<?php echo U('member',array('id'=>$content['id']));?>">全部成员 <span class="badge"><?php echo ($all_count); ?></span></a>
        <a class="btn btn-default  <?php if($tip == sign): ?>active<?php endif; ?>"  href="<?php echo U('member',array('id'=>$content['id'],'tip'=>'sign'));?>">未审核 <span id="sign_count" class="badge"><?php echo ($sign_count); ?></span></a>
        <a class="btn btn-default  <?php if($tip == attend): ?>active<?php endif; ?>"  href="<?php echo U('member',array('id'=>$content['id'],'tip'=>'attend'));?>">已审核 <span id="attend_count" class="badge"><?php echo ($attend_count); ?></span></a>
        <a  class="btn btn-default" href="<?php echo U('detail',array('id'=>$content['id']));?>">返回活动详情页</a>
    </div>
...
<div class="event_member_list" style="margin-top: 15px;">
    <?php if(is_array($content['member'])): $i = 0; $__LIST__ = $content['member'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-2" style="height: 180px;">
            <div style="width: 128px;">
                <img ucard="<?php echo ($vo["id"]); ?>" src="<?php echo ($vo["avatar128"]); ?>" class="avatar-img" style="width: 128px;float: left"/>
                <div style="text-align: center;">
                    <div><a href="<?php echo ($vo["space_url"]); ?>"> <?php echo ($vo["nickname"]); ?> </a></div>
                    <?php if($content['uid'] == is_login() ){ ?>

                    <a class="event_see_info" title="查看姓名联系方式"><span class="glyphicon glyphicon-hand-up"></span></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span>
                    <?php if($vo['status'] == 0): ?><a data-eventID="<?php echo ($content['id']); ?>" data-uid="<?php echo ($vo["id"]); ?>" onclick="shenhe($(this))" title="通过审核"><span class="glyphicon glyphicon-ok"></span></a>
                        <?php else: ?>
                         <a data-eventID="<?php echo ($content['id']); ?>" data-uid="<?php echo ($vo["id"]); ?>"  onclick="qushenhe($(this))"  title="取消审核"><span class="glyphicon glyphicon-remove"></span></a><?php endif; ?>
...
<link type="text/css" rel="stylesheet" href="/opensns/Public/Core/js/ext/atwho//atwho.css"/>
    ...
    <script type="text/javascript" src="/opensns/Public/Core/js/ext/magnific/jquery.magnific-popup.min.js"></script>
    <script type="text/javascript" src="/opensns/Public/Event/js/event.js"></script>
    <script>
        $(function () {
